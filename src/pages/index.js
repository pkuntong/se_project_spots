...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Ensure that your selectors work by checking if the elements exist
  if (!editProfileButton || !profileImage || !profileName || !profileDescription) {
    console.error("Some profile elements could not be found in the DOM.");
    return;
  }

  // API call to get app info
  api
    .getAppInfo()
    .then(([cards, users]) => {
      if (!Array.isArray(cards) || !users) {
  ...
  function getCardElement(data) {
    ...
    cardImageElement.alt = data.name; // Set alt to name
